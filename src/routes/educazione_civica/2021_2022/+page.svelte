<script>
    ...
    const timeline = [
        {
            yearTitle: "FISICA",
            materiaDesc: "ASTROFISICA & INGEGNERIA PLANETARIA",
            projects: [
                {
                    title: "Terraformazione Pianeti",
                    meta: "PRESENTAZIONE // A.S. 2021/2022",
                    desc: "Indagine sulle sfide dell'astrofisica moderna: l'applicazione di leggi fisiche per trasformare l'ambiente di Marte attraverso l'ingegneria planetaria, con focus sulla gestione delle radiazioni cosmiche e la dinamica dei campi magnetici artificiali.",
