<script>
    ...
    const timeline = [
    {
        yearTitle: "TELECOMUNICAZIONI",
        materiaDesc: "INFRASTRUTTURE DI RETE & INTELLIGENZA ARTIFICIALE",
        projects: [
            {
                title: "Modern Presentazione AI",
                meta: "PRESENTAZIONE // A.S. 2023/2024",
    ...
    {
        yearTitle: "STORIA",
        materiaDesc: "ANALISI CRITICA: LEGALITÀ & ECO-SISTEMI SOCIALI",
        projects: [
            {
                title: "Eco Mafie",
                meta: "PRESENTAZIONE // A.S. 2023/2024",
